        ...
        return new AbstractSdxAction<>(SdxStartDetachEvent.class) {
            ...
            protected void doExecute(SdxContext context, SdxStartDetachEvent payload,
                ...
                sdxStatusService.setStatusForDatalakeAndNotify(
                        DatalakeStatusEnum.STOPPED, "Datalake detach in progress.", payload.getResourceId()
                );

                SdxCluster cluster = sdxClusterRepository.findById(payload.getResourceId())
                ...
                variables.put(DETACHED_SDX, sdxDetachService.detachCluster(cluster));
    ...
    public Action<?, ?> sdxDetachExternalDBFailedAction() {
        return new AbstractSdxAction<>(SdxDetachFailedEvent.class) {
            ...
            protected void doExecute(SdxContext context, SdxDetachFailedEvent payload,
                ...
                detached = sdxAttachService.reattachCluster(detached);
                sdxAttachService.reattachStack(detached, ((SdxCluster) variables.get(RESIZED_SDX)).getClusterName());
    ...
    public Action<?, ?> sdxAttachNewCluster() {
        return new AbstractSdxAction<>(SdxEvent.class) {
            ...
            protected void doExecute(SdxContext context, SdxEvent payload,
                ...
                sdxStatusService.setStatusForDatalakeAndNotify(
                        DatalakeStatusEnum.STOPPED, "Datalake is detached.", detachedCluster.getId()
                );
                ...
                resizedCluster = sdxAttachService.attachSdx(resizedCluster);
                sdxStatusService.setStatusForDatalake(
                        DatalakeStatusEnum.REQUESTED, "Newly attached datalake requested.", resizedCluster
                );
    ...
    public Action<?, ?> sdxAttachNewClusterFailedAction() {
        return new AbstractSdxAction<>(SdxDetachFailedEvent.class) {
            ...
            protected void doExecute(SdxContext context, SdxDetachFailedEvent payload,
                ...
                detached = sdxAttachService.reattachSdx(detached);
