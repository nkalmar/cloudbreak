...
if [[ "$CIRCLECI" ]]; then
    ...
    export INTEGRATIONTEST_AWS_DISKENCRYPTION_ENVIRONMENTKEY=$INTEGRATIONTEST_AWS_DISKENCRYPTION_ENVIRONMENTKEY
    export INTEGRATIONTEST_AWS_DISKENCRYPTION_DATAHUBKEY=$INTEGRATIONTEST_AWS_DISKENCRYPTION_DATAHUBKEY
