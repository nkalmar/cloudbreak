...
public abstract class AbstractE2ETest extends AbstractIntegrationTest {
     ...
     */
    protected void determineCloudPlatformForTest(@Nonnull CloudPlatform cloudPlatform) {
     ...
     */
    protected void notSupportedCloudPlatform(@Nonnull CloudPlatform cloudPlatform) {
        String cloudProvider = commonCloudProperties().getCloudProvider();
        assertThat(
