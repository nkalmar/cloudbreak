...
public enum ResourceEvent {
    ...
    DATALAKE_CCM_UPGRADE("datalake.ccm.upgrade"),
    DATALAKE_CCM_UPGRADE_ERROR_INVALID_COUNT("datalake.ccm.upgrade.error.invalid.count"),
    DATALAKE_CCM_UPGRADE_ERROR_ENVIRONMENT_IS_NOT_LATEST("datalake.ccm.upgrade.error.environment.notlatest"),
    DATALAKE_CCM_UPGRADE_ERROR_ENVIRONMENT_IS_NOT_AVAILABLE("datalake.ccm.upgrade.error.environment.notavailable"),
    DATALAKE_CCM_UPGRADE_NO_DATALAKE("datalake.ccm.upgrade.no.datalake"),
    DATALAKE_CCM_UPGRADE_ALREADY_UPGRADED("datalake.ccm.upgrade.already.upgraded"),
    DATALAKE_CCM_UPGRADE_NOT_UPGRADEABLE("datalake.ccm.upgrade.not.upgradeable"),
    DATALAKE_CCM_UPGRADE_NOT_AVAILABLE("datalake.ccm.upgrade.not.available"),
    DATALAKE_CCM_UPGRADE_FAILED("datalake.ccm.upgrade.failed"),
    DATALAKE_CCM_UPGRADE_IN_PROGRESS("datalake.ccm.upgrade.inprogress"),
